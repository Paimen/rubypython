...
Gem::Specification.new do |s|
  ...
  s.require_paths = ["lib"]
  s.authors = ["Steeve Morin", "Austin Ziegler", "Zach Raines", "Juhapekka Piiroinen"]
  s.date = "2017-03-17"
  ...
  s.email = ["swiuzzz+rubypython@gmail.com", "austin@rubyforge.org", "raineszm+rubypython@gmail.com", "jp@1337.fi"]
